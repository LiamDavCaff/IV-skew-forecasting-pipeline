...
OUT_FILE <- file.path(DATA_DIR, "bbg_dax_data.rds")
...
spx_spot <- bdh("DAXK Index",  "PX_LAST", as.Date("2005-01-01"), as.Date("2025-07-31")) %>% 
  rename(date = date, price = PX_LAST)

vix_df   <- bdh("V1X Index", "PX_LAST", as.Date("2005-01-01"), as.Date("2025-07-31")) %>% 
